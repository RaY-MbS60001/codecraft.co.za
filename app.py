...
def init_learnership_emails():
    ...
    with app.app_context():
        ...
        email_data = [
            {"company_name": "Tych Talent Solutions", "email": "precious@tych.co.za"},
            {"company_name": "Progression Consulting", "email": "farhana@progression.co.za"},
            {"company_name": "QASA Empowerment", "email": "recruitment@qasa.co.za"},
            {"company_name": "TLO Skills Development", "email": "recruitment@tlo.co.za"},
            {"company_name": "Dibanisa Learning Academy", "email": "slindile@dibanisalearning.co.za"},
            {"company_name": "Tric Talent Recruitment", "email": "anatte@trictalent.co.za"},
            {"company_name": "Novia One Consulting", "email": "tai@noviaone.com"},
            {"company_name": "Edge Executive Solutions", "email": "kgotso@edgexec.co.za"},
            {"company_name": "Related Education", "email": "kagiso@related-ed.com"},
            {"company_name": "Skills Panda Recruitment", "email": "refiloe@skillspanda.co.za"},
            {"company_name": "RMA Education Services", "email": "skills@rma.edu.co.za"},
            {"company_name": "Signa Skills Development", "email": "nkhensani@signa.co.za"},
            {"company_name": "CSG Skills Training", "email": "sdube@csgskills.co.za"},
            {"company_name": "SITA Learning", "email": "lerato.recruitment@sita.co.za"},
            {"company_name": "TJH Business Solutions", "email": "melviln@tjhbusiness.co.za"},
            {"company_name": "Thandsh Consulting", "email": "moodleyt@thandshc.co.za"},
            {"company_name": "Kunaku Development", "email": "learners@kunaku.co.za"},
            {"company_name": "KLM Empowered", "email": "learnership@klmempowered.com"},
            {"company_name": "Talent Connect", "email": "applications@talentconnect.co.za"},
            {"company_name": "Skills Hub", "email": "learn@skillshub.co.za"},
            {"company_name": "Career Boost", "email": "opportunities@careerboost.co.za"},
            {"company_name": "Talent Horizon", "email": "learners@talenthorizon.com"},
            {"company_name": "Skill Bridge", "email": "development@skillbridge.co.za"},
            {"company_name": "Career Catalyst", "email": "programs@careercatalyst.co.za"},
            {"company_name": "Upskill Solutions", "email": "learning@upskillsolutions.co.za"}
        ]
